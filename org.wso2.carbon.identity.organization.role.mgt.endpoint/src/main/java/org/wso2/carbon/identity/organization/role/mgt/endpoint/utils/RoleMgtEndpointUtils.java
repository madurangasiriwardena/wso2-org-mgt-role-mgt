...
package org.wso2.carbon.identity.organization.role.mgt.endpoint.utils;
...
public class RoleMgtEndpointUtils {
    ...
    private static ErrorDTO getError(String message, String description, String code) {
    ...
    public static NotFoundException buildNotFoundRequestException(String description, String message, String code,
        ...
        ErrorDTO errorDTO = getError(message, description, code);
        logDebug(log, e);
    ...
    public static InternalServerErrorException buildInternalServerErrorException(String code, Log log, Throwable e) {
        ...
        ErrorDTO errorDTO = getError(Response.Status.INTERNAL_SERVER_ERROR.toString(),
